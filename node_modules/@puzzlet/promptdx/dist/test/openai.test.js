...
const openaiCompletionParamsWithTools = {
    ...
    messages: [
        {
            role: "system",
            content: "You are a helpful assistant capable of solving basic math problems and using tools as needed.",
        },
        {
            role: "user",
            content: "What is 7 + 5?",
...
test("should serialize tools", async () => {
    ...
    const serialized = serialize(openaiCompletionParamsWithTools, "gpt-4o-mini", "calculate");
    expect(serialized).toEqual(mdx);
});
